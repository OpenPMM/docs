...
The destination list contains connected publishing targets. It does not contain disconnected provider placeholders. The `status` column is `ready`, `disabled`, `reauthorization-required`, or `unavailable`.
