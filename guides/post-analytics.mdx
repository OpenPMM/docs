...
OpenPMM collects current metrics for Posts that it publishes.
...
OpenPMM uses seven metric names:

| Metric | Meaning |
| --- | --- |
| Views | Provider-reported content views or plays |
| Impressions | Provider-reported screen appearances |
...
Views and impressions are different metrics.
OpenPMM does not convert impressions into views.
