---
title: "API overview"
description: "Learn the base URL and rules for the OpenPMM API."
---
...
- Send the API key as a bearer token on each API request.
...
<Note>
  Private dashboard routes under `/api` are not part of the public API.
</Note>
