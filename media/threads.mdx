...
description: "See the video and image limits that OpenPMM applies for a Threads destination."
---
...
attaches to the opening post. OpenPMM checks both the Threads post quota and
reply quota before publication. Existing connections must be reconnected once
